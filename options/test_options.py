...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--pic_b_path", type=str, default='./demo_file/elon-musk-hero-image.png', help="Person who provides information other than their identity")
